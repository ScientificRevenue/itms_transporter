...
:: echo JAVAVERRETVAL = %JAVAVERRETVAL%
...
:: echo JAVAVERRETVAL for 1.7 = %JAVAVERRETVAL%

:: if they aren't using 1.6 or 1.7 display an error and exit
if %JAVAVERRETVAL% NEQ 0 echo Java 1.6 or Java 1.7 is required. Please upgrade. The current default java version is ...
